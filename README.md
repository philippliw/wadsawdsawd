...
After like over a year, it's done!! So here's ripoff Bee Swarm Simulator

A bit of stuff is different but the gameplay is the same

Supports fullscreen and data saving

If you name a world with a certain secret passcode you can enable cheats and get infinite stuffs

The game is also on github at Dddatt/bss and also on Replit
